...
Version  : 0.109
Release  : 9
URL      : https://cpan.metacpan.org/authors/id/R/RJ/RJBS/Mixin-Linewise-0.109.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/R/RJ/RJBS/Mixin-Linewise-0.109.tar.gz
...
%prep
%setup -q -n Mixin-Linewise-0.109
cd %{_builddir}/Mixin-Linewise-0.109
...
cp %{_builddir}/Mixin-Linewise-0.109/LICENSE %{buildroot}/usr/share/package-licenses/perl-Mixin-Linewise/6f883c73668a2b7a2ad205ccda91c0ab9cad376a
if test -f Makefile.PL; then
